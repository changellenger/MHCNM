...
try{
    ...
    rs = pstmt.executeQuery();
   	...
   	String[] MOV_NUMBER = new String[4];
...
<td>
    ...
    <td colspan="2">
    <center>
    <a href="managermovieUpdate.jsp?THE_NUMBER=0" class="testbutton" style="margin:0px 20px 0px 20px" >수정하기</a>
	<a href="managermovieDelete.jsp?THE_NUMBER=0" class="testbutton" >삭제하기</a>
    </center></td>
    </tr>
    </center>
    </font>
...
<td>
    ...
    <td colspan="2">
    <center>
    <a href="managermovieUpdate.jsp?THE_NUMBER=1" class="testbutton" style="margin:0px 20px 0px 20px" >수정하기</a>
	<a href="managermovieDelete.jsp?THE_NUMBER=1" class="testbutton" >삭제하기</a>
    </center>
    </td>
    </tr>
    </center>
...
<td>
    ...
    <td colspan="2">
    <center>
    <a href="managermovieUpdate.jsp?THE_NUMBER=2" class="testbutton" style="margin:0px 20px 0px 20px" >수정하기</a>
	<a href="managermovieDelete.jsp?THE_NUMBER=2" class="testbutton" >삭제하기</a>
    </center>
    </td>
    </tr>
    </center>
...
<td>
    ...
    <td colspan="2">
    <center>
    <a href="managermovieUpdate.jsp?THE_NUMBER=3" class="testbutton" style="margin:0px 20px 0px 20px" >수정하기</a>
	<a href="managermovieDelete.jsp?THE_NUMBER=3" class="testbutton" >삭제하기</a>
    </center>
    </td>
    </tr>
    </center>
...
<br><br>
<a href="addmovie.jsp" class="testbutton" >추가하기</a>
<br><br>
