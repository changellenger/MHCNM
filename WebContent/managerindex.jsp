...
%>
<li>
<a href="managerindex.jsp"><img src="<%=MOV_IMAGE3[0]%>" onmouseover="this.src='<%=MOV_IMAGE2[0]%>';" onmouseout="this.src='<%=MOV_IMAGE3[0]%>';" alt=""></a>
</li>

<li>
<a href="managerindex.jsp"><img src="<%=MOV_IMAGE3[1]%>" onmouseover="this.src='<%=MOV_IMAGE2[1]%>';" onmouseout="this.src='<%=MOV_IMAGE3[1]%>';" alt=""></a>
</li>

<li>
<a href="managerindex.jsp"><img src="<%=MOV_IMAGE3[2]%>" onmouseover="this.src='<%=MOV_IMAGE2[2]%>';" onmouseout="this.src='<%=MOV_IMAGE3[2]%>';" alt=""></a>
</li>

<li>
<a href="managerindex.jsp"><img src="<%=MOV_IMAGE3[3]%>" onmouseover="this.src='<%=MOV_IMAGE2[3]%>';" onmouseout="this.src='<%=MOV_IMAGE3[3]%>';" alt=""></a>
</li>
</ul>
</div>
</div>
