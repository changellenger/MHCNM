		...
		<div id="body">
			...
			<p><input type="image" src="images/screen.jpg"  name="screen"  width="450" height="30"></p><br /><br />
 						...
 						try {
 						    ...
 						    String sql = "Select * from MOVIE WHERE THE_NUMBER='"+movie+"' AND TAB_NUMBER='"+timet+"' ";
 						    pstmt = con.prepareStatement(sql); 
 						    rs = pstmt.executeQuery();
 						   int[] possible = new int[99];
 						   int p=0;
 						   while(rs.next()){
 							   p++;
 					...
 					<%
 						k++;
   						...
   						<span><input type="checkbox" name="cbox" value="<%=j %><%=i %>" offsrc="images/gray.png" onsrc="images/gray.png" disabled /> </span>
 					<%	k++;
 					  }
					}
				%></p><%}
